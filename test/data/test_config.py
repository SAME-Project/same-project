...
good_config = "test/ops/testdata/same_configs/good_same.yaml"

# List of SAME config files that are broken in various ways:
#   name, path
bad_configs = [
    ("no api version", "test/ops/testdata/same_configs/no_apiVersion.yaml"),
    ("no default environment", "test/ops/testdata/same_configs/no_default_for_environments.yaml"),
]
