...
from . import AuthBase, BaseAdapter, HTTPAdapter, Session, _basic_auth_str, extract_cookies_to_jar, get_auth_from_url, get_netrc_auth, Retry
...
from ...common.url import add_username_and_password, get_proxy_username_and_pass, split_anaconda_token, urlparse
...
class CondaSession(Session):
    def __init__(self):
        ...
        if context.offline:
            ...
            # Configure retries
            retry = Retry(total=context.remote_max_retries, backoff_factor=context.remote_backoff_factor, status_forcelist=[413, 429, 500, 503], raise_on_status=False)
