...
from ._vendor.six import PY2, PY3, integer_types, iteritems, iterkeys, itervalues, string_types, text_type, wraps
...
#     def Utf8NamedTemporaryFile(mode="w+b", bufsize=-1, suffix="", prefix=template, dir=None, delete=True):
#         if "CONDA_TEST_SAVE_TEMPS" in os.environ:
#             delete = False
#         return codecs.getwriter("utf-8")(NamedTemporaryFile(mode=mode, bufsize=bufsize, suffix=suffix, prefix=template, dir=dir, delete=delete))


# else:

#     def Utf8NamedTemporaryFile(mode="w+b", buffering=-1, newline=None, suffix=None, prefix=None, dir=None, delete=True):
#         if "CONDA_TEST_SAVE_TEMPS" in os.environ:
#             delete = False
#         encoding = None
#         if not "b" in mode:
#             encoding = "utf-8"
#         return NamedTemporaryFile(mode=mode, buffering=buffering, encoding=encoding, newline=newline, suffix=suffix, prefix=prefix, dir=dir, delete=delete)
