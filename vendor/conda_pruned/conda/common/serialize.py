...
def yaml_safe_dump(object):
    """dump object to string"""
    return yaml.dump(object, block_seq_indent=2, default_flow_style=False, indent=2)
...
def json_dump(object):
    return ensure_text_type(json.dumps(object, indent=2, sort_keys=True, separators=(",", ": "), cls=EntityEncoder))
