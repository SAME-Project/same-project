...
#-------------------------------------------------------------------------------------------------------------
#
# Adapted from the docker-init.sh script generated by the docker-from-docker devcontainer image setup script.
# See https://github.com/microsoft/vscode-dev-containers/blob/main/containers/docker-from-docker/.devcontainer/library-scripts/docker-debian.sh
